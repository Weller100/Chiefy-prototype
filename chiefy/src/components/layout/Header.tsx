...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 bg-gray-900 text-white z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-xl font-bold">Chiefy</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex-1 max-w-xl mx-8 relative">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 rounded-lg bg-white/10 border border-white/20 focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-transparent text-white placeholder:text-white/60"
                />
              ...
              {showSearchResults && (
                <div className="absolute top-full left-0 right-0 mt-2 bg-gray-800 bg-opacity-90 rounded-lg shadow-lg border border-white/20 z-50">
                  <div className="p-2">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                {showNotifications && (
                  <div className="absolute right-0 mt-2 w-80 bg-gray-800 bg-opacity-90 rounded-lg shadow-lg border border-white/20 z-50">
              ...
              <div className="relative">
                ...
                {showProfileMenu && (
                  <div className="absolute right-0 mt-2 w-64 bg-gray-800 bg-opacity-90 rounded-lg shadow-lg border border-white/20 z-50">
                    <div className="p-4 border-b border-gray-200">
      ...
      {/* Sliding Sidebar - only the sidebar, no overlay */}
      <div
        className={`fixed top-16 left-0 h-[calc(100%-4rem)] w-64 bg-gray-800 bg-opacity-80 shadow-lg transform transition-transform duration-300 ease-in-out z-40 ${
